 ...
 */
@WebServlet(name = "UpdateBookData", urlPatterns = {"/updateBookData"})
@MultipartConfig(
...
public class UpdateBookData extends HttpServlet {
    ...
    private void updateBookData(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        HttpSession session = request.getSession();
        ...
        book.setPublishingYear(publisherYear);
